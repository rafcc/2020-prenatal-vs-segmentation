...
class UNet(object):
    ...
    def create_model(self):
        ...
        enc1 = Conv2D(self.first_filter, self.CONV_FILTER_SIZE, strides=self.CONV_STRIDE)(enc1)
        ...
        # (128 x 128 x N)
        filter_count = self.first_filter
        ...
        dec8 = Conv2DTranspose(self.output_channel, self.DECONV_FILTER_SIZE, strides=self.DECONV_STRIDE)(dec8)
        dec8 = Activation(activation='sigmoid')(dec8)

        self.MODEL = Model(inputs=inputs, outputs=dec8)
